...
#echo post to document directly at google ; curl -i -H "Content-Range: bytes 0-29/30" -H "Content-Type: text/plain" -H "X-Upload-Content-Length: 30" -H "X-Upload-Content-Type: text/plain" -H "origin: http://myfavouritesandwich.org" -H "GData-Version: 3.0" -H "Authorization: Bearer $1" -H "Slug: remoteStorage-curl" -H "Content-Length: 30" -X PUT -d "123456789012345678901234567890" https://docs.google.com/feeds/default/private/full/document%3A$2

#echo put to document directly at google ; curl -i -H "Content-Range: bytes 0-29/30" -H "Content-Type: text/plain" -H "Content-Length: 30" -H "Origin: http://myfavouritesandwich.org" -X PUT -d "123456789012345678901234567890" https://docs.google.com/feeds/default/private/full/document%3A1AGkSTWNlXm9DcvnC673PtTpFuntOuMBHZKhMKiVxNX4
