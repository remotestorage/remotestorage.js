          ...
          return env.client.storeObject('test', 'testobj', { hello: 'world' }).
            then(function() {
              ...
              env.serverHelper.expectRequest(
                ...
                JSON.stringify({ 
                  'hello': 'world',
                  '@context': 'https://remotestoragejs.com/spec/modules/root/test'
                })
              );
        ...
        run: function(env) {
          ...
          env.client.storeObject('test', 'test-dir/obj', { phu: 'quoc' }).
            then(function() {
              ...
              env.serverHelper.expectRequest(_this, 'PUT', 'me/test-dir/obj', '{"phu":"quoc","@context":"https://remotestoragejs.com/spec/modules/root/test"}');
              env.serverHelper.expectRequest(_this, 'GET', 'me/test-dir/');
              env.serverHelper.expectNoMoreRequest(_this);
              _this.assert(true, true);
            });
          ...
          env.client.storeObject('test', 'foo/bar/test-obj', { phu: 'quoc' }).
            then(function() {
              expectEvent({
                ...
                oldValue: undefined,
                newValue: { phu: 'quoc', '@context': 'https://remotestoragejs.com/spec/modules/root/test' }
              });
