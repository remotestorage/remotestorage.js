...
for(i in sampleData) {
  ...
  if((iou.payer == 'you') &&(iou.status == 'closed')) {
    document.write('<li style="background-color:yellow">[was declined] [NO]'+iou.payee+' '+iou.amount+iou.currency+'</li>');
  }
  if((iou.payee == 'you') &&(iou.status == 'closed')) {
    document.write('<li style="background-color:yellow">[was declined] [NO]'+iou.payer+' '+iou.amount+iou.currency+'</li>');
  }
  if((iou.payer == 'you') && (iou.status == 'sent')) {
    document.write('<li style="background-color:pink">[you sent] [X]'+iou.payee+' '+iou.amount+iou.currency+'</li>');
  }
  if((iou.payer == 'you') && (iou.status == 'received')) {
    document.write('<li style="background-color:pink">[they received] [X]'+iou.payee+' '+iou.amount+iou.currency+'</li>');
  }
  if((iou.payee == 'you') && (iou.status == 'received')) {
    document.write('<li style="background-color:green">[you received] [X]'+iou.payer+' '+iou.amount+iou.currency+'</li>');
  }
}
