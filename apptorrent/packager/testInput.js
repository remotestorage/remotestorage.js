var testInput = 
''//'<!DOCTYPE HTML>'
+'<html lang="en-US"><head><title>Simple Planner</title><meta charset="utf-8" /><link href="style.css" rel="stylesheet" type="text/css" /><script src="http://ajax.aspnetcdn.com/ajax/jQuery/jquery-1.6.2.min.js"></script><script src="lib.js"></script></head><body class="dark"><div id="calendar-wrap" class="box"><div id="calendar"><h1 id="calendar-title"> </h1><ul id="controls"><li><a href="#" id="btn-theme">light</a></li><li class="sep"><a href="#" id="btn-ical">iCal</a></li><li><a href="#" id="btn-previous">\n'
+'laquo;'//+'&laquo;'
+'</a></li><li><a href="#" id="btn-today">today</a></li><li><a href="#" id="btn-next">\n'
+'raquo;'//+'&raquo;'
+'</a></li></ul><div class="clear"> </div><h3 id="time"> </h3><table id="table"><thead></thead><tbody></tbody></table><div class="clear"> </div><h2 id="stats"></h2><p class="info">Click on a date to view events. Use arrow keys to browser the calendar.\n<span class="info" id="credit">localStorage based personal planner by <a href="http://kailashnadh.name">Kailash Nadh</a> for <a href="http://10k.aneventapart.com">10k Apart</a></span></p><div class="clear"> </div></div><div class="clear"> </div></div><div \nid="diary-wrap" class="box"><div class="content"><a href="#" id="diary-close" class="round">&lt;</a><h2 \nid="diary-title">\n'
+'nbsp;'//+'&nbsp;'
+'</h2><div class="clear"> </div><ul id="diary"></ul><p class="info">Click on a time to \nadd an event</p></div></div><div id="dialog"><a href="#" id="dialog-close" class="round">x</a><form \nid="add" class="target"><h2 id="event-date"></h2><p class="time"><label>Event time</label>Hour <select \nid="event-hour"></select>Minute <select id="event-minute"></select></p><p><label>Event description</label>\n<input type="text" id="event-description" maxlength="100" /></p><div id="event-label"></div><p class="buttons"><input type="submit" id="event-create" value="ok" class="button" />\n<input type="button" id="event-close" value="cancel" class="button" /><input type="button" id="event-delete" \nvalue="delete" class="button" /><input type="button" id="event-tweet" value="tweet" class="button" />\n</p></form><div id="ical" class="target">Copy the text and save it as  calendar.ics file.<br /><small>\nYou can then import the file to Google Calendar, iCal etc.</small><textarea id="ical-data"> </textarea></div></div><div class="clear"> </div></body></html>'
/*
		Simple Planner
