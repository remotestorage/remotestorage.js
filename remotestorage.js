...
RemoteStorage.Assets = {
  ...
  widget: ' <div class="bubble">   <div class="bubble-text">     Connect <strong>remotestorage</strong>   </div>   <div class="bubble-expandable">     <form novalidate>       <input  type="email" placeholder="user@host" name="userAddress" novalidate>       <button class="connect" name="connect" title="connect" disabled="disabled">         <img>       </button>     </form>     <div class="info">       This app allows you to use your own storage! Find more info on       <a href="http://remotestorage.io/" target="_blank">remotestorage.io</a>     </div>   </div>    </div> <img class="cube action">  ',
